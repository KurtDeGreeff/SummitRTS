...
LINUX_SHARE_SCRIPTS_DIR=`echo $a | sed -n /LINUX_SHARE_SCRIPTS_DIR/p /LocalDropbox/properties.txt | awk '{print $3}'`
LINUX_LOCAL_SCRIPTS_DIR=`echo $a | sed -n /LINUX_LOCAL_SCRIPTS_DIR/p /LocalDropbox/properties.txt | awk '{print $3}'`
